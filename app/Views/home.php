...
<div id="view-reflection" class="hidden flex-1 flex flex-col overflow-y-auto bg-bg">
    ...
    <div class="fixed bottom-0 inset-x-0 bg-bg/80 backdrop-blur-md safe-area-inset-bottom">
        ...
        <div class="p-4 flex items-center gap-4">
            ...
            <button id="btn-save" class="w-[56px] h-[56px] rounded-full bg-sage text-white flex items-center justify-center hover:bg-[#5a6b5a] transition-colors shadow-lg shadow-sage/20 active:scale-95 transition-transform">
